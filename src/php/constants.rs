...
into_const_num!(u8, zend_register_long_constant);
into_const_num!(u16, zend_register_long_constant);
into_const_num!(u32, zend_register_long_constant);
into_const_num!(u64, zend_register_long_constant);
